Route12_Object:
	...
	def_objects
	object SPRITE_SNORLAX,  2, 62, STAY, DOWN, 1 ; person
	object SPRITE_FISHER, 10, 99, STAY, LEFT, 2, OPP_FISHER, 3
	object SPRITE_FISHER,  4, 83, STAY, UP, 3, OPP_FISHER, 4
	object SPRITE_COOLTRAINER_M, 11, 92, STAY, LEFT, 4, OPP_JR_TRAINER_M, 9
	object SPRITE_SUPER_NERD, 14, 76, STAY, UP, 5, OPP_ROCKER, 2
	object SPRITE_FISHER, 12, 90, STAY, LEFT, 6, OPP_FISHER, 5
	object SPRITE_FISHER, 13, 83, STAY, RIGHT, 7, OPP_FISHER, 6
	object SPRITE_FISHER, 6, 87, STAY, DOWN, 8, OPP_FISHER, 11
	object SPRITE_POKE_BALL, 10, 39, STAY, NONE, 9, TM_PAY_DAY
