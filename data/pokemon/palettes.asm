...
ELSE
	...
	db PAL_BROWNMON ; Decilla
	db PAL_BROWNMON ;GYAOON
	db PAL_REDMON ;TRIFOX
	db PAL_BROWNMON ;GUARDIA
	db PAL_REDMON ;MINICORN
	db PAL_GREENMON ;MAGNETITE
	db PAL_CYANMON ;TOTATLE
	db PAL_PINKMON ;BLOONDER
	db PAL_REDMON ;GOLPPY
	db PAL_BLUEMON ;FREEZETI
	db PAL_GREYMON ;TRAMPEL
	db PAL_GREENMON ;CROCKY
	db PAL_BLUEMON ;BLOTTLE
	db PAL_BLUEMON ;PENDRAKEN
	...
	db PAL_GREYMON ;SCARIBOU
	db PAL_GREENMON ;NIDOREIGN
